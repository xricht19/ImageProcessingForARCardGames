...
namespace IDAP
{
	...
	extern "C" {
		...
		extern DllExport void InitImageDetectionAccessPointCaller(ImageDetectionAccessPoint*, uint16_t&, uint16_t&, const char*);
		...
		extern DllExport void IsPlayerActiveByIDCaller(ImageDetectionAccessPoint*, uint16_t&, uint16_t&);
